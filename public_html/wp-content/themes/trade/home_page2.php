   				...
   				if (have_rows('Premium Plans2')):
   					while (have_rows('Premium Plans2')):the_row();
   						...
   						<div class="col-xl-4 col-md-4 col-lg-4 col-sm-4 ">
   							...
   							<?php $current_user = wp_get_current_user(); if (is_user_logged_in()) { 
...
add_filter('wp_footer', 'slider');
add_filter('wp_footer', 'tinkoff_pay_popup');
add_filter('wp_footer', 'tinkoff_v2');
