...
<nav class="navbar navbar-expand-lg navbar-light bsnav">
	<div class="container-fluid">
		...
		if (is_user_logged_in()) {
			...
			<div style="position: absolute; right: 2%;display: flex;">
				<a href="<?php echo get_home_url();?>/settings/" id="current_user-user_login" style="margin-right: 15px; margin-top: 2px; text-decoration: none; color: #2d3436;">
	...
	<!-- <button id="login_btn_popup2" type="button" class="btn btn-nav-menu" >LOGIN2</button> -->


	<!-- кнопка открывает popup -->
	<!-- <a id="login_btn_popup" type="button" class="btn btn-nav-menu" style="position: absolute; right: 2%;">LOGIN</a> -->
